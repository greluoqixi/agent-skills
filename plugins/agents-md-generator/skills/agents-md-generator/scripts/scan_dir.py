...
and reports file counts per directory. Used by agents-md-generator to decide where
AGENTS.md files are needed.
...
def main():
    parser = argparse.ArgumentParser(description="Scan project directory for AGENTS.md generation")
