...
**Anti-patterns**: Listing every pip dependency; documenting PEP 8 (not project-specific); writing the README into CLAUDE.md instead of using `@README.md`.
...
- `_perception` packages: Python prototying OK, C++ for deployment
