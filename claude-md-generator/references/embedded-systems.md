...
## Dual-Layer CLAUDE.md Strategy

When a project contains both hardware-near and algorithm-near code at significant scale, split documentation into two CLAUDE.md files:

### Root CLAUDE.md (hardware context)
...
### Algorithm subdirectory CLAUDE.md (domain context)
...
This split keeps hardware noise out of algorithm documentation and vice versa. The algorithm CLAUDE.md is free to discuss numerical methods and control theory without needing to prefix every file path with hardware details.
